            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <p class="text-sm text-muted mb-0">{{ $employee->email }}</p>
                        <p class="text-sm text-muted mb-0">{{ $employee->phone }}</p>
                        <p class="text-sm text-muted mb-0">{{ $employee->address }}</p>
                    </div>
                </div>
            </div>
            <div class="card mt-3">
        ...
        <div class="col-md-8">
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <h6 class="mb-0">Number of Sites</h6>
                        </div>
                        <div class="col-sm-9 text-secondary">
                            {{ $employee->amazonSite->count() }}
                        </div>
                    </div>
                    <hr>
                </div>
            ...
            <div class="row gutters-sm">
                ...
                <div class="col-sm-6 mb-3">
                    <div class="card h-100">
                        <div class="card-body">
                            <h6 class="d-flex align-items-center mb-3"><i
                                    class="material-icons text-danger mr-2">Assigned Sites</i>Sites Incompleted</h6>
